window.CONTENT_EN = {
  ...
  "projects": [
    {
      ...
      "coverImage": { "src": "images/web-coderpad-cover.jpg", "alt": "CoderPad product visual: homepage screen and candidate performance stats (rank, duration, score)." },
      "role": ["Churn diagnosis & user interviews (with the PM)", "Co-ran the product hackathon", "Designed AI features (grading, chatbot, follow-ups)", "Rebuilt the design system to be AI-ready"],
    ...
    },
    {
      ...
      "coverImage": { "src": "images/web-wisecure-cover.jpg", "alt": "Preview of the Wisecure app on mobile: home screen, incident map and alert detail." },
      ...
      "process": [
        ...
        { "num": "02", "step": "Geolocated reporting", "title": "A clear map to place every alert", "desc": "I designed the incident map as the main entry point: immediate localization of nearby incidents, report creation in a few steps, and a visible status so people following an alert stay reassured.", "image": { "src": "images/web-wisecure-cover.jpg", "alt": "Wisecure screens: incident map and report-creation flow.", "caption": "The incident map and the report-creation flow, designed to stay simple to use under stress.", "w": 2000, "h": 1004 } },
    ...
    },
    {
      ...
      "coverImage": { "src": "images/web-dualsun-cover.jpg", "alt": "Dualsun product visual: mobile solar production tracking and the desktop/mobile solar solutions simulator." },
    ...
    },
    {
      ...
      "coverImage": { "src": "images/web-airbus-cover.jpg", "alt": "Overview of the Airbus UX study: personas, journey map and the production KPI monitoring dashboard." },
  ...
  "testimonials": [
    {
      "quote": "Estée really helped us bring all our ideas to life for our UX and UI project, to improve the experience for our end users.",
      "name": "Thomas G.",
