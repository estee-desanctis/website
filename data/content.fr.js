  ...
  "articles": [
    {
      ...
      "body": "Sur mes missions, je construis et je fais vivre des design systems Figma avec quatre skills Claude que j'ai écrites moi-même, pensées pour s'enchaîner comme un vrai pipeline. <strong class=\"skill-name\">fds-charte-graphique</strong> pose les fondations de marque (couleurs, typographie, logos, espacements, effets, grilles, rayons, traits) directement dans Figma, avec la collection de variables Root qui va avec et un contrôle de contraste WCAG affiché sous chaque couleur. <strong class=\"skill-name\">fds-design-system</strong> prend le relais : à partir de ces tokens Root, elle construit les tokens sémantiques Alias (clair/sombre), priorise une liste de composants alignée sur les conventions MUI, puis construit ces composants un par un, en anglais, accessibles et documentés. <strong class=\"skill-name\">fds-new-component</strong> intervient à l'unité : elle prend un seul composant existant dans un fichier Figma déjà structuré en Root/Alias/Components et le rend pleinement tokenisé, thémé et accessible, sans toucher au reste du système — utile pour compléter ou réparer un composant isolé. <strong class=\"skill-name\">fds-audit</strong>, enfin, sert de bilan de santé global : elle évalue l'architecture des tokens, le naming, la complétude et l'accessibilité d'un design system existant, donne un verdict par élément (garder, améliorer, refondre) et un plan d'action priorisé, et peut ensuite relancer automatiquement les trois autres skills pour appliquer les corrections retenues. Les quatre skills sont génériques : elles fonctionnent sur n'importe quel fichier Figma, pas seulement les miens, et sont en libre accès sur GitHub pour toute personne qui veut les essayer ou les adapter.",
      "links": [
