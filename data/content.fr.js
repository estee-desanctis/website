  ...
  "projects": [
    {
      ...
      "role": ["Diagnostic churn & entretiens utilisateurs (avec le PM)", "Co-animation du hackathon produit", "Design des fonctionnalités IA (notation, chatbot, relances)", "Refonte du design system IA-ready", "Référente design system & IA pour l'équipe design (3 personnes), sans lien hiérarchique"],
    ...
    },
    {
      ...
      "role": ["Design UX/UI (0→1, en solo)", "Recherche utilisateur", "Design system mobile", "Mission freelance de 3 mois, cadrée et livrée en autonomie, sans PM dédié"],
      ...
      "process": [
        ...
        { "num": "03", "step": "Rassurer au quotidien", "title": "Un tableau de bord de quartier lisible", "desc": "En dehors des situations d'urgence, l'app devait aussi donner confiance au quotidien : statistiques de quartier, mise en avant des agents certifiés, et accès rapide aux fonctionnalités clés depuis l'écran d'accueil." }
      ]
    },
    {
      "id": "dualsun",
